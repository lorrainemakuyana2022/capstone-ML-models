...
#include <ei/tensorflow/lite/kernels/internal/reference/quantize.h>
#include <ei/tensorflow/lite/kernels/internal/reference/requantize.h>
...
#include <ei/tensorflow/lite/micro/kernels/quantize.h>
