...
using int16 = int16_t;
using int32 = int32_t;
#include <ei/tensorflow/lite/kernels/internal/reference/integer_ops/transpose_conv.h>
#include <ei/tensorflow/lite/kernels/internal/reference/transpose_conv.h>
