...
#include <ei/tensorflow/lite/micro/kernels/fully_connected.h>
...
#include <ei/tensorflow/lite/kernels/internal/reference/fully_connected.h>
#include <ei/tensorflow/lite/kernels/internal/reference/integer_ops/fully_connected.h>
